...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--lr', type=float, default=1.25e-4/2, 
                             help='learning rate for batch size 32.') # 这个感觉要除8啊
    ...
    self.parser.add_argument('--batch_size', type=int, default=4, # 默认32
                             help='batch size')
